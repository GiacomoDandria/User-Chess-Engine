...
bool cavallo::moveCavalloCheck(std::string inputMovement) {
	...
	//controllo se la mossa fa parte delle azioni possibili, ovvero controllo se l'input
	//passato dall'utente corrisponde alla "mossa ad L" che il cavallo puo' fare
